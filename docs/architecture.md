# codesupply: Architecture & System Topology

**Domain**: CycloneDX v1.5 SBOM Generator & Software Supply-Chain Risk Engine  
**Description**: Enterprise Software Bill of Materials (SBOM) generator, vulnerability correlation engine, and transitive dependency license compliance analyzer.
...
sequenceDiagram
    ...
    participant Engine as codesupply Core
